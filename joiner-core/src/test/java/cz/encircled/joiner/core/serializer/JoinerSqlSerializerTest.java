 ...
 */
public class JoinerSqlSerializerTest extends AbstractTest {

    private JoinerSQLSerializer serializer;
    private final QUser user = QUser.user1;

    private final String selectUser = "select distinct user1.parent_id, user1.last_login, user1.active, user1.salary, user1.id, user1.name";
    ...
    public void setUp() {
        ...
        serializer = new JoinerSQLSerializer(namingStrategy);
    }
    ...
    class PredicateChains {
        ...
        public void singleWhereClause() {
            JoinerQuery<?, ?> query = Q.from(user).where(user.name.eq("John").and(user.lastLogin.isNotNull()));
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.name = ?1 and user1.last_login is not null", jpql);
        ...
        public void chainOfSameOperators() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.name = ?1 and user1.active = ?2", jpql);
        ...
        public void chainOfSameOperatorsWithParentheses() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where (user1.id = ?1 and user1.user is null) and user1.name = ?2", jpql);
        ...
        public void orThenAndChain() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.id > ?1 and (user1.name = ?2 or user1.name = ?3)", jpql);
        ...
        public void orWithNestedAndClause() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(
                    selectUser + " from test_user user1 where user1.id = ?1 or (user1.name = ?2 and user1.id > ?3)",
                    jpql
            );
        ...
        public void multipleNestedClauses() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(
                    selectUser + " from test_user user1 where user1.name = ?1 or (user1.name = ?2 and (user1.id = ?3 or user1.id < ?4))",
                    jpql
            );
        ...
        public void andInsideOrWithAdditionalAnd() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(
                    selectUser + " from test_user user1 where user1.id between ?1 and ?2 and (user1.name = ?3 or (user1.name = ?4 and user1.id = ?5))",
                    jpql
            );
        ...
        public void tripleNestedPredicates() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(
                    selectUser + " from test_user user1 where user1.id = ?1 or (user1.name = ?2 and (user1.id > ?3 or user1.id < ?4))",
                    jpql
            );
    ...
    class ExpressionOperators {
        ...
        public void inWithSingleParam() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.id = ?1", jpql);
        ...
        public void inWithMultipleParam() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.id in ?1", jpql);
        ...
        public void notInWithMultipleConstants() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.id not in ?1", jpql);
            assertConstants(serializer, List.of(0L, 1L));
        }
        ...
        public void notInWithTwoParams() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.id not in (user1.id, user1.id)", jpql);
        ...
        public void notInWithMultipleParams() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.id not in ((user1.id, user1.id), user1.id)", jpql);
            assertConstants(serializer);
        }
        ...
        public void isNull() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.id is null", jpql);
            assertConstants(serializer);
        }
        ...
        public void startsWith() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.name like ?1", jpql);
        ...
        public void startsWithIgnoreCase() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where lower(user1.name) like ?1", jpql);
            assertConstants(serializer, "j%");
        }
    ...
    class Joins {
        ...
        public void leftJoins() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 left join test_group group1 on user1.id = group1.id", jpql);
        }
        ...
        public void leftJoinOn() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 left join test_group group1 on not length(group1.name) = 0", jpql);
        }
        ...
        public void leftJoinSingular() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 left join test_user user on user1.parent_id = user.id", jpql);
        }
        ...
        public void innerJoins() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 inner join test_group group1 on user1.id = group1.id", jpql);
        }
        ...
        public void testNestedJoins() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 left join test_group group1 on user1.id = group1.id left join test_user user1_on_group1 on group1.id = user1_on_group1.id", jpql);
        }

        @Test
        public void testJoinsInPredicate() {
            JoinerQuery<?, ?> query = Q.from(address)
                    .where(address.user.id.ne(Q.select(user1.id.max()).from(group).joins(J.inner(address.user))));
            String jpql = serializer.serialize(query);
            assertEquals("select distinct address.user_id, address.city, address.id, address.name from test_address address where address.user.id <> (select max(user1.id) from test_group group1 inner join test_user user on address.user_id = user.id)", jpql);
        }
    ...
    public void testOrderBy() {
        ...
        String jpql = serializer.serialize(query);
        assertEquals(selectUser + " from test_user user1 order by user1.name asc", jpql);
        assertConstants(serializer);
    }
    ...
    public void testGroupBy() {
        ...
        String jpql = serializer.serialize(query);
        assertEquals(selectUser + " from test_user user1 group by user1.name, user1.id", jpql);
    }
    ...
    public void testHaving() {
        ...
        String jpql = serializer.serialize(query);
        assertEquals(selectUser + " from test_user user1 group by user1.name having user1.id > ?1", jpql);
        assertConstants(serializer, 0L);
    }
    ...
    class BasicProjections {
        ...
        public void rootCustomAlias() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select distinct my_user.name from test_user my_user", jpql);
            assertConstants(serializer);
        }
        ...
        public void singleColumnProjection() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select distinct user1.name from test_user user1", jpql);
            assertConstants(serializer);
        }
        ...
        public void singleJoinedColumnProjection() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select distinct group1.name from test_user user1 left join test_group group1 on user1.id = group1.id", jpql);
            assertConstants(serializer);
        }
        ...
        public void starEntityProjection() {
            JoinerQuery<?, ?> query = Q.from(user);
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1", jpql);
            assertConstants(serializer);
        }
        ...
        public void dtoMappingProjection() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select distinct user1.name, user1.id from test_user user1", jpql);
            assertConstants(serializer);
        }
    }
    ...
    class FunctionProjection {
        ...
        public void testLowerFunction() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select lower(user1.name) from test_user user1", jpql);
            assertConstants(serializer);
        }
        ...
        public void testSubstringFunction() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select substring(user1.name, ?1) from test_user user1", jpql);
        ...
        public void testSubstring2Function() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select substring(user1.name, ?1, ?2) from test_user user1", jpql);
        ...
        public void testCoalesceProjection() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select coalesce(user1.salary, user1.id) from test_user user1", jpql);
            assertConstants(serializer);
        }
        ...
        public void testLengthFunction() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select length(user1.name) from test_user user1", jpql);
            assertConstants(serializer);
        }
        ...
        public void testConcatFunction() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select concat(user1.name, user1.name) from test_user user1", jpql);
            assertConstants(serializer);
        }
        ...
        public void rootCountProjection() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select count(1) from test_user user1", jpql);
            assertConstants(serializer);
        }
        ...
        public void columnCountProjection() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select count(address.id) from test_address address group by address.user", jpql);
        }
        ...
        public void distinctColumnCountProjection() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select count(distinct address.id) from test_address address group by address.user", jpql);
        }
        ...
        public void customCountProjection() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select count(user1) from test_user user1", jpql);
            assertConstants(serializer);
        }
        ...
        public void distinctCustomCountProjection() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select count(distinct user1) from test_user user1", jpql);
            assertConstants(serializer);
        }
        ...
        public void testAvgFunction() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select avg(address.id) from test_address address group by address.user", jpql);
        }
        ...
        public void testMaxFunction() {
            ...
            assertEquals("select max(address.id) from test_address address group by address.user", jpql);
        }
        ...
        public void testMinFunction() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select min(address.id) from test_address address group by address.user", jpql);
        }
        ...
        public void testSumFunction() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select sum(address.id) from test_address address group by address.user", jpql);
        }
        ...
        public void testFunctionInHaving() {
            ...
            assertEquals("select avg(address.id) from test_address address group by address.user having count(address.id) > ?1", jpql);
    ...
    class SqlFunctions {
        ...
        public void testLocateFunction() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where locate(?1, user1.name) > ?2", jpql);
        ...
        public void testUpperFunction() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where upper(user1.name) = ?1", jpql);
            assertConstants(serializer, "JOHN");
        }
        ...
        public void testLowerFunction() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where lower(user1.name) = ?1", jpql);
            assertConstants(serializer, "john");
        }
        ...
        public void testConcatFunction() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where concat(user1.name, ?1) = ?2", jpql);
        ...
        public void testSubstringFunction() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where substring(user1.name, ?1, ?2) = ?3", jpql);
        ...
        public void testTrimFunction() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where trim(user1.name) = ?1", jpql);
            assertConstants(serializer, "John");
        }
        ...
        public void testAbsFunction() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where abs(user1.id) = ?1", jpql);
        ...
        public void testSqrtFunction() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where sqrt(user1.id) > ?1", jpql);
        ...
        public void testModFunction() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where mod(user1.id, ?1) = ?2", jpql);
    ...
    class PredicateOperators {
        ...
        public void testBetween() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.id between ?1 and ?2", jpql);
        ...
        public void testCoalesceConstant() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where coalesce(user1.salary, ?1) >= ?2", jpql);
        ...
        public void testCoalesceWithExpression() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where coalesce(user1.salary, user1.id) >= ?1", jpql);
        ...
        public void testIsEmpty() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.groups is empty", jpql);
            assertConstants(serializer);
        }
        ...
        public void testIsNotEmpty() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where not user1.groups is empty", jpql);
            assertConstants(serializer);
        }
        ...
        public void testAssociationSize() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where size(user1.groups) > ?1", jpql);
            assertConstants(serializer, 2);
        }
        ...
        public void testCoalesce() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where coalesce(user1.name, ?1) = ?2", jpql);
        ...
        public void testNullif() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where nullif(user1.name, ?1) is null", jpql);
        ...
        public void testCast() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select user1.id numcast ?1 from test_user user1", jpql);
    ...
    class LogicalOperators {
        ...
        public void testAnd() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.name = ?1 and user1.id > ?2", jpql);
        ...
        public void testOr() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.name = ?1 or user1.id > ?2", jpql);
            assertConstants(serializer, "John", 10L);
        }
        ...
        public void testNot() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where not user1.name = ?1", jpql);
            assertConstants(serializer, "John");
        }
    }

    @Nested
    @Disabled // Requires implicit join in subquery
    class Subquery {
        @Test
        public void testSubQueryInPredicate() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.id = ?1 or user1.id in (select distinct address.user.id from test_address address where address.id = ?2)", jpql);
        ...
        public void testNestedSubQueryInPredicate() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.id <> (select max(user1.id) from test_user user1)", jpql);
            assertConstants(serializer);
        }
        ...
        public void testSubQueryExistsEq() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where exists (select 1 from test_group user1_groups_0 where user1_groups_0.name = ?1)", jpql);
        ...
        public void testJoinSubQueryExistsEq() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals("select distinct address.user_id, address.city, address.id, address.name from test_address address left join test_user user on address.user_id = user.id where exists (select 1 from test_group address_user_groups_0 where address_user_groups_0.name = ?1)", jpql);
            assertConstants(serializer, "test sq");
        }
        ...
        public void testNestedSubQueryExists() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where exists (select 1 from test_user1.groups user1_groups_0 inner join user1_groups_0.statuses user1_groups_0_statuses_1 where user1_groups_0_statuses_1.name = ?1)", jpql);
            assertConstants(serializer, "test sq");
        }
        ...
        public void testSubQueryExistsSingleArgOp() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where exists (select 1 from test_group user1_groups_0 where user1_groups_0.name is not null)", jpql);
            assertConstants(serializer);
        }
    }
    ...
    class ComparisonOperators {
        ...
        public void testEqualityPredicate() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.salary = ?1", jpql);
        ...
        public void testNotEqualPredicate() {
            ...
            String jpql = serializer.serialize(query);
            assertEquals(selectUser + " from test_user user1 where user1.name <> ?1", jpql);
