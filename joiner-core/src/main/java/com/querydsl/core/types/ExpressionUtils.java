...
public final class ExpressionUtils {
     ...
     * @return all col
     */
    /*TODO subquery @SuppressWarnings("unchecked")
     ...
     * @return left in right
     */
    /*TODO subquery public static <D> Predicate in(Expression<D> left, SubQueryExpression<? extends D> right) {
        return predicate(Ops.IN, left, right);
    }*/
     ...
     * @return left not in right
     */
    /*TODO subquery public static <D> Predicate notIn(Expression<D> left, SubQueryExpression<? extends D> right) {
        return predicate(Ops.NOT_IN, left, right);
    }*/
