...
class SpringJoinerKtRepositoryBaseImpl<T, E : EntityPath<T>>(val joiner: JoinerKt, val entityPath: E) :
    ...
    override fun find(pageable: Pageable, query: JoinerKtQuery<T, T, E>.() -> Any): Page<T> {
    ...
    private fun getTotalCount(request: JoinerKtQuery<T, T, E>): Long {
        val countRequest = request.copy() as JoinerKtQuery<T, Long, E>
        countRequest.count()
